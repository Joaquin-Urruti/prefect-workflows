...
1. [Introducción a Prefect](#introducción-a-prefect)
...
- Retornan valores
- Se pueden reintentar automáticamente
...
- `"30 2 1 * *"` - Primer día del mes a las 2:30 AM
...
# ✗ MAL: Logging excesivo o ausente
@task
def procesar(items: list):
    for item in items:
